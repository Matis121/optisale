...
class OrderStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_status" do
    assert_difference("OrderStatus.count") do
      post order_statuses_url, params: { order_status: { full_name: @order_status.full_name, short_name: @order_status.short_name, user_id: @order_status.user_id } }
    end
  ...
  test "should update order_status" do
    patch order_status_url(@order_status), params: { order_status: { full_name: @order_status.full_name, short_name: @order_status.short_name, user_id: @order_status.user_id } }
